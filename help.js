...
module.exports = {
  ...
  run: async (client, message, args) => {
   ...
   let helpEmbed = new MessageEmbed()
      .setTitle("**Here are __MonsterUltra__ commands**")
      ...
      .addField(
        "• **GENERAL**",
        "```servericon , calculator , invite , membercount ,  help , serverinfo , leaderboard, dm``` "
      )
      .addField(
        "• **GIVEAWAY**",
        "```gstart , gend , greroll```"
      ...
      .addField(
        "• **MODERATION**",
        "```lockchannel , purge , slowmode , mute , unmute ,   nuke , poll```"
      )
      .addField(
        "• **OWNER**",
      ...
      .addField('Important Links ','**[Invite Me](https://discord.com/oauth2/authorize?client_id=959412858309971998&permissions=8&scope=bot)** **• [Support](https://discord.gg/Zwc24UNuQ6)**  | **[Website](https://sites.google.com/view/monsterultra-monstergang/home?)**')
